  ...
  />
      ...
      <div className="relative z-10">
        ...
        <div className="w-full flex items-center justify-between px-[128px] pt-[38px]">
          ...
          {/* Search Bar */}
          <div className="w-full max-w-[461px] h-[47px] flex items-center gap-[10px] bg-white/10 backdrop-blur-md rounded-[20px] border border-white/20 px-[20px] py-[10px] shadow-md">
            <svg
